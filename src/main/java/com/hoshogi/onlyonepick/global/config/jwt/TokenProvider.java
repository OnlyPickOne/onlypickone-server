...
public class TokenProvider {
    ...
    private static final long REFRESH_TOKEN_EXPIRE_TIME = 1000 * 60 * 60 * 24 * 14;  // 14 day
    ...
    public TokenResponse generateToken(Authentication authentication, String email) {
